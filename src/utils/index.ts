...
export const uploadFile = async (file:any, signedUrl:any, enqueueSnackbar:any) => {
...
export const camelizeKeys = (obj:any) =>
  transform(obj, (acc:any, value:any, key:string, target: Record<string | number | symbol, any>) => {
