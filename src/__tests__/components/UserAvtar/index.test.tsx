...
describe("Avtar", () => {
  ...
  it("renders correctly when User have no avatar", () => {
    const tree = renderer.create(<PersonAvatar avatar={undefined && ''}/>).toJSON();
    expect(tree).toMatchSnapshot();
  });

  it("renders correctly when User have avatar", () => {
